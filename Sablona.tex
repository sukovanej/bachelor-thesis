...
\KlicovaSlova{kvantová mechanika, kvantová teorie pole, relativistická kvantová mechanika}{quantum mechanics; quantum field theory, relativistic quantum mechanics}
...
V hlavní části spočítáme vlastnosti hustoty pravděpodobnosti vyplívající ze získaných rovnic a zabýváme se pojmem kauzality
...
and an analytical aproximation we show the causality breaks within our conditions. In the last part we sketch
the quatization of the Klein-Gordon field and we check causality works using the new approach.}
...
\DatumProhlaseni{23. května 2019}
