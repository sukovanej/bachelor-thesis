...
\NazevUstavu{Ůstav teoretické fyziky a astrofyziky}{Department of physics and astrophysics}

\RokOdevzdaniPrace{2019}

\AkademickyRok{2018/2019}

\Autor{Milan Suk}{Milan Suk}

\NazevPrace{Aspekty přechodu od kvantové mechaniky ke kvantové teorii pole}{Aspekty přechodu od kvantové mechaniky ke kvantové teorii pole}{Aspects of the transition from quantum mechanics to quantum field theory}
...
\VedouciPraceSTituly{doc. Klaus Bering Larsen, Ph.D} %% Neni potreba pro rigorozni prace

\StudijniProgram{Fyzika}{Physics}

\StudijniObor{Fyzika}{Physics}

\PocetStran{x\,$+$\,29}

\KlicovaSlova{kvantová mechanika; kvantová teorie pole; relativistická kvantová mechanika; Klein-Gordonova rovnice; Diracova rovnice; 
    kauzalita}{quantum mechanics; quantum field theory: relativistic quantum mechanics: Klein-Gordon equation; Dirac equation}

\Abstrakty%
{V této bakalářské práci se věnujeme přechodu kvantové mechaniky ke kvantové teorii pole. Nejdříve se zabýváme
Diracovou kanonickou kvantizací a konstrukcí relativistických rovnic, Klein-Gordonovy rovnice a Diracovy rovnice.
V hlavní části spočítáme vlastnosti hustoty pravděpodobnosti vyplíva-\\jící ze získaných rovnic a zabýváme se pojmem kauzality
v kontextu relativistické fyziky. Pomocí aproximační analytické metody a numerické metody ukážeme, že nastavené
podmínky pro kauzalitu neplatí. V poslední části načrtneme kvantizaci Klein-Gordonova pole a nakonec ukážeme,
že pro novou relativistickou teorii už problémům s kauzalitou nečelíme.}%
{In this thesis, we study the transition from quantum mechanics to quantum field theory. We start by dealing
with the Dirac canonical quantization and construction of the relativistic equations, Klein-Gordon equation and 
Dirac equation. In the main chapter, we investigate the properties of the probability density using the found
equations and we deal with the causality within the context of a relativistic physics. Using both a numerical method 
and an analytical approximation we show the causality breaks within our conditions. In the last part, we sketch
the quantization of the Klein-Gordon field and we check causality works using the new approach.}

\TextPodekovani%
{On this place I would like to thank to doc. Klaus Bering Larsen, Ph.D for his guidance and priceless advices
during supervising this thesis. Also, I would like to thank my friends and family for pushing and supporting me
in completing the thesis. Special thanks goes to Martin Vokal and Petra Zelena being the closest people around
me for their support.}

\TextProhlaseni%
{I hereby declare that I have composed the presented thesis independently on my
own and without any other resources than the ones indicated. All thoughts taken directly or indirectly from external sources are properly denoted as such.}

\DatumProhlaseni{May 23, 2019}
...
\newcommand{\partialdernd}[2] {\frac{\partial^{2} #1}{\partial #2^{2}}}
...
\includepdf[pages=-,pagecommand={},width=1.2\textwidth]{is_tisk.pdf}
...
\HlavickaKapitoly
\vloz{text_prace/05_Kapitola_03}
\cleardoublepage

\HlavickaZaver
\vloz{text_prace/06_Zaver}
\cleardoublepage

\renewcommand{\bibname}{Bibliography}
\HlavickaLiteratura
\vloz{text_prace/08_Literatura}
\cleardoublepage
