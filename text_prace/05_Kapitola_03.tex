...
$\mathcal{L}(\vec{x}, t, \phi, \partialder{\phi}{\vec{x}}, \partialder{\phi}{t}, \dots)$ instead.

\begin{equation}
    \label{eq:lagrangian_density}
    L = \int d\vec{x} \ \mathcal{L}(\vec{x}, t, \phi, \partialder{\phi}{\vec{x}}, \partialder{\phi}{t}, \dots)
\end{equation}
...
As was shown in \cite{goldstein} the dynamics of $\phi$ is given by the equation
