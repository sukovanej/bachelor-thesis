...
We have to make sure whether the values $p_{+}$, $p_{-}$ are saddle points. Firstly we will check whether they solve the quadratic equation.

Now we find the value of the Hessian $\partialdernd{S(p)}{p}$ in the saddle point $p_{+}$.
...
Thus we can conclude the amplitude $A_{2}$ is
